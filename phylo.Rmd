---
title: "rlog(), scale(), and FPKM phylogenetic trees"
author: "Sidd Lokray"
date: "`r Sys.Date()`"
output:
...
library(systemPipeR);library(ShortRead);library(data.table);library(poolr);library(dendextend)
...
## rlog()
``` {r rlog, fig.height=12, fig.width=12}
...
## scale()
``` {r scale, fig.height=12, fig.width=12}
tableEdgeR <- read.table('./mouseedgeRcomp.xls')
...
## FPKM
``` {r fpkm, fig.height=12, fig.width=12}
